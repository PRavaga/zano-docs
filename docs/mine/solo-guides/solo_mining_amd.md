...
3. To determine whether the driver was properly installed, we need the application ****clinfo****. Install that, and then check for your GPU: [^4]
   ...
   <div>
   <img src="/static/img/mine/solo-mining-guides/amd-clinfo.png" width="800" />
   </div>
...
<div>
<img src="/static/img/mine/solo-mining-guides/amd-daemon_synced.png" width="800" />
</div>
...
<div>
<img src="/static/img/mine/solo-mining-guides/amd-wildrig_running.png" width="800" />
</div>
