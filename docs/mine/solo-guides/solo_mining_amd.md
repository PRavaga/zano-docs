<div align="center">
<img src="img/mine/solo-mining-guides/linuxzano_icon.png" width="400" />
...
3. To determine whether the driver was properly installed, we need the application ****clinfo****. Install that, and then check for your GPU: [^4]
   ...
   <div>
   <img src="img/mine/solo-mining-guides/linuxamd-clinfo.png" width="800" />
   </div>
...
<div>
<img src="img/mine/solo-mining-guides/linuxamd-daemon_synced.png" width="800" />
</div>
...
<div>
<img src="img/mine/solo-mining-guides/linuxamd-wildrig_running.png" width="800" />
</div>

And if you switch to the terminal with your daemon running, you should now see this:

<div>
<img src="img/mine/solo-mining-guides/linuxnvidia-daemon_mining.png" width="800" />
</div>
